  	...
  	extend: {
  		colors: {
  			...
  			wellness: {
  				...
  				surface: 'hsl(var(--wellness-surface))',
  			...
  			gradient: {
  				...
  				cerise: 'hsl(var(--gradient-cerise))',
  		...
  		keyframes: {
  			...
  			'pulse-glow': {
  				'0%': { boxShadow: '0 0 20px hsl(var(--wellness-glow) / 0.3)' },
  				'100%': { boxShadow: '0 0 40px hsl(var(--wellness-glow) / 0.6)' }
  			},
  			'particle-float': {
  				'0%': {
